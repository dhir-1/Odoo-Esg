...
from app.models.gamification import Badge, Reward, Challenge, ChallengeParticipation, EmployeeBadge, RewardRedemption
...
# Set database URL dynamically from our config
